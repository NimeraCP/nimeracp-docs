...
<Callout emoji="💡">
Want to see everything it can do? Check out our [setup guide](/getting-started/installation) and [feature list](/features)
</Callout>

## Getting Started

Ready to jump in? If you're hosting it yourself, our [setup guide](/getting-started) will walk you through getting NimeraCP up and running. After that, you can tweak everything to make it work just how you want.
